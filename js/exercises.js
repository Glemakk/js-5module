...
// const newCar = new Car('bmw', 'X5', 50000);
...
//   this.price = price;
// }
// const newCar = new Car({name:'BMW', model:'M4', price:120000});
...
//         //или return без перебора и if используем для перебора indexOf(i)
...
//class Storage{
//   #items; 
    ////нам не надо передавать объект, поэтому items в параметрах constructor без {}
//   constructor(items){
//   this.#items = items;
//   }
